...
const UserProfile = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center transition-colors duration-300">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-gray-700 transition-colors duration-300">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Loading Profile</h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
      {/* Header */}
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center gap-6">
              <button
                onClick={handleBackToChat}
                className="flex items-center gap-3 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-all duration-200 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 px-4 py-2 rounded-xl border border-blue-200 dark:border-blue-700"
              >
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-xl hover:bg-red-100 dark:hover:bg-red-900/50 transition-colors font-medium border border-red-200 dark:border-red-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isLoggingOut ? (
                  <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(error || success) && (
          <div className="mb-6">
            {error && (
              <div className="p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 text-red-800 dark:text-red-300 rounded-xl mb-4 flex justify-between items-center shadow-sm transition-colors duration-300">
                <div className="flex items-center gap-3">
                ...
                <button onClick={clearMessages} className="text-red-500 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 p-1 transition-colors">
            ...
            {success && (
              <div className="p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 text-green-800 dark:text-green-300 rounded-xl mb-4 flex justify-between items-center shadow-sm transition-colors duration-300">
                <div className="flex items-center gap-3">
                ...
                <button onClick={clearMessages} className="text-green-500 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 p-1 transition-colors">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                  </svg>
                </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stats.conversations || 0}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">Conversations</div>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400">{stats.messages || 0}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">Messages</div>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{stats.recent_activities || 0}</div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">{stats.account_age_days || 0}</div>
              ...
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 py-4 px-6 text-sm font-medium whitespace-nowrap transition-all duration-200 ${
                    activeTab === tab.id 
                      ? 'border-b-2 border-blue-500 text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/30' 
...
const ProfileTab = ({ profile, setProfile, setSuccess, setError, getAuthHeaders, API_URL }) => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Profile Information</h3>
      ...
      <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 transition-colors duration-300">
        <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Profile Picture</h4>
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">PNG, JPG, GIF up to 2MB. Recommended: 400x400px</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-500 dark:placeholder-gray-400 transition-colors"
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
              >
        ...
        {/* Bio Section */}
        <div>
          <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">About You</h4>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Bio</label>
            <textarea
              value={formData.bio}
              onChange={(e) => setFormData({...formData, bio: e.target.value})}
              className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 h-32 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-500 dark:placeholder-gray-400 resize-none transition-colors"
...
const SettingsTab = ({ settings, setSettings, setSuccess, setError, getAuthHeaders, API_URL }) => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Preferences & Settings</h3>
        <p className="text-gray-600 dark:text-gray-300">Customize your experience and notification preferences.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 transition-colors duration-300">
          ...
          <div className="space-y-6">
            <div>
              <ThemeSelector className="w-full md:w-64" />
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Choose your preferred color scheme</p>
            </div>
            
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-600 rounded-xl border border-gray-200 dark:border-gray-500 transition-colors duration-300">
                <div className="flex-1">
                  <label htmlFor="compact_mode" className="text-sm font-medium text-gray-700 dark:text-gray-200">
                    Compact Mode
                  </label>
                  <p className="text-xs text-gray-500 dark:text-gray-300 mt-1">Use smaller UI elements to fit more content</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-600 rounded-xl border border-gray-200 dark:border-gray-500 transition-colors duration-300">
                <div className="flex-1">
                  <label htmlFor="show_timestamps" className="text-sm font-medium text-gray-700 dark:text-gray-200">
                    Show Message Timestamps
                  </label>
                  <p className="text-xs text-gray-500 dark:text-gray-300 mt-1">Display when each message was sent</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-600 rounded-xl border border-gray-200 dark:border-gray-500 transition-colors duration-300">
                <div className="flex-1">
                  <label htmlFor="sidebar_collapsed" className="text-sm font-medium text-gray-700 dark:text-gray-200">
                    Start with Sidebar Collapsed
                  </label>
                  <p className="text-xs text-gray-500 dark:text-gray-300 mt-1">Hide the chat history sidebar by default</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 transition-colors duration-300">
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Default Assistant Model</label>
              <select
                value={formData.default_assistant_model}
                onChange={(e) => setFormData({...formData, default_assistant_model: e.target.value})}
                className="w-full md:w-80 border border-gray-300 dark:border-gray-500 rounded-xl px-4 py-3 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
              >
                <option value="gpt-4-1106-preview">GPT-4 Turbo (Recommended)</option>
                <option value="gpt-4">GPT-4 (Standard)</option>
                <option value="gpt-3.5-turbo">GPT-3.5 Turbo (Faster)</option>
              </select>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Choose the AI model that best fits your needs</p>
            </div>
            
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-600 rounded-xl border border-gray-200 dark:border-gray-500 transition-colors duration-300">
                <div className="flex-1">
                  <label htmlFor="chat_sound_enabled" className="text-sm font-medium text-gray-700 dark:text-gray-200">
                    Chat Sounds
                  </label>
                  <p className="text-xs text-gray-500 dark:text-gray-300 mt-1">Play notification sounds for new messages</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-600 rounded-xl border border-gray-200 dark:border-gray-500 transition-colors duration-300">
                <div className="flex-1">
                  <label htmlFor="auto_save_conversations" className="text-sm font-medium text-gray-700 dark:text-gray-200">
                    Auto-save Conversations
                  </label>
                  <p className="text-xs text-gray-500 dark:text-gray-300 mt-1">Automatically save your chat history</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="w-32 border border-gray-300 dark:border-gray-500 rounded-xl px-4 py-3 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                />
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 transition-colors duration-300">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-600 rounded-xl border border-gray-200 dark:border-gray-500 transition-colors duration-300">
              <div className="flex-1">
                <label htmlFor="email_notifications" className="text-sm font-medium text-gray-700 dark:text-gray-200">
                  Email Notifications
                </label>
                <p className="text-xs text-gray-500 dark:text-gray-300 mt-1">Receive important updates via email</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
            ...
            <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-600 rounded-xl border border-gray-200 dark:border-gray-500 transition-colors duration-300">
              <div className="flex-1">
                <label htmlFor="push_notifications" className="text-sm font-medium text-gray-700 dark:text-gray-200">
                  Push Notifications
                </label>
                <p className="text-xs text-gray-500 dark:text-gray-300 mt-1">Get instant notifications in your browser</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
        ...
        <div className="flex justify-end pt-6 border-t border-gray-200 dark:border-gray-600 transition-colors duration-300">
          <button
            type="submit"
            disabled={saving}
            className="px-8 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl hover:from-blue-600 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium shadow-lg flex items-center gap-2"
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Notifications</h3>
        ...
        {unreadCount > 0 && (
          <button
            ...
            disabled={loading}
            className="px-4 py-2 text-sm bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors font-medium border border-blue-200 dark:border-blue-700 disabled:opacity-50 flex items-center gap-2"
          >
            {loading ? (
              <>
      ...
      <div className="space-y-4">
        {notifications.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 dark:bg-gray-700 rounded-2xl transition-colors duration-300">
            <svg className="w-16 h-16 text-gray-300 dark:text-gray-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
            </svg>
            <h4 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No notifications yet</h4>
              ...
              <div className="flex justify-between items-start">
                ...
                {!notification.read_status && (
                  <button
                    ...
                    className="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 ml-4 transition-colors"
                  >
                    Mark as read
                  </button>
                )}
...
const SecurityTab = ({ setSuccess, setError, getAuthHeaders, API_URL }) => {
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold mb-6 text-gray-900 dark:text-gray-100">Security Settings</h3>
        ...
        <form onSubmit={handlePasswordChange} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 dark:border-gray-500 rounded-md px-3 py-2 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
              required
            />
          </div>
...
const AccountTab = ({ stats, setSuccess, setError, getAuthHeaders, API_URL, showDeleteConfirm, setShowDeleteConfirm, logout }) => {
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold mb-6 text-gray-900 dark:text-gray-100">Account Management</h3>
      
      <div className="space-y-8">
        {/* Data Export */}
        <div>
          <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Export Your Data</h4>
        ...
        {stats && (
          <div>
            <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Account Statistics</h4>
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 transition-colors duration-300">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 font-medium text-gray-900 dark:text-gray-100">{stats.conversations}</span>
                </div>
                <div>
                  <span className="text-gray-600 dark:text-gray-300">Total Messages:</span>
                  <span className="ml-2 font-medium text-gray-900 dark:text-gray-100">{stats.messages}</span>
                </div>
                <div>
                  <span className="text-gray-600 dark:text-gray-300">Recent Activities:</span>
                  <span className="ml-2 font-medium text-gray-900 dark:text-gray-100">{stats.recent_activities}</span>
                </div>
                <div>
                  <span className="text-gray-600 dark:text-gray-300">Account Age:</span>
                  <span className="ml-2 font-medium text-gray-900 dark:text-gray-100">{stats.account_age_days} days</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Delete Account */}
        <div className="border-t border-gray-200 dark:border-gray-600 pt-8 transition-colors duration-300">
